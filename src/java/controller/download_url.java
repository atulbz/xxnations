 ...
 * @author Shaishav
 */
public class download_url extends HttpServlet {
                ...
                if(song_id1.isEmpty() || "".equals(song_id1) || song_id1==null)
            {
                ...
                if (i <= 0) {
                    ...
                    if (count < 0) {
                        ...
                        Random k = new Random();
                        String s = "" + k.nextLong();
                        tempservice x = new tempservice(classname, driver);
                        int setTemp = x.setTemp(user_id, s, list1.getSong_url(),list1.getLen());
                         String url="http://"+request.getHeader("Host") +"/downloadqueue.do?k="+s+"&sname="+list1.getSong_name().trim();
                        ...
                        if (setTemp == 1) {
                            response.sendRedirect("downloadqueue.do?k=" + s + "&sname=" + list1.getSong_name().trim());
                        } else {
                            ...
                            response.sendRedirect("downloadqueue.do?k=" + es + "&sname=" + list1.getSong_name().trim());
                ...
                System.out.print("Error in Download_url " + e);
            } finally {
                out.close();
            }
        }
