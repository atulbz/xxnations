...
public class adminforgotpassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String result=obj.adminforgot(email);
            
            if("success".equals(result))
            {
                out.print("Password has been successfully send to Email click <a href=\"../admin/login.jsp\">here</a> to Login ");
                
            }
            else
            {
                out.print("Please provide correct Email Address click <a href=\"../admin/forgotpassword.jsp\">here</a> to try again");
            }
