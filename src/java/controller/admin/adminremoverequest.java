         ...
         protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                 throws ServletException, IOException {
                  ...
                  try {
                         HttpSession hs=request.getSession(false);
                           if("admin".equals((String)hs.getAttribute("role")))
                           {
              ...
              catch(Exception e)
              {
               ...
               if(i==1)
               {
                     ...
                     out.print("Request has been removed click <a href=\"../admin/adminrequesthistory.jsp?user_id="+user_id+"\">here</a> to go back");   
               }
