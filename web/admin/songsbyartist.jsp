...
<body>
	...
	<!-- End Header -->
	<div id="help-nav">
			<a href="songmgmt.jsp">Manage Songs</a> &gt; List songs by Artist
		</div>
	...
	<div align="center">
       ...
       List list=obj1.getArtist();   
request.setAttribute("list", list);                
%>


 <display:table   name="list" class="dataTable" id="table" pagesize="6"  size="<%=list.size() %>" requestURI="songsbyartist.jsp" >
           <display:setProperty name="paging.banner.placement" value="bottom" /> 
          
           <display:column title="Artist Name"><a href="../admin/listsongbyartist.jsp?Artist_name=${table.artist_name}">${table.artist_name}</a></display:column>
  </display:table>
