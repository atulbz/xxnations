<%-- 
    Document   : cannotremove
    Created on : Jan 23, 2012, 1:24:28 AM
    Author     : Shaishav
--%>
...
<html>
	...
	<div id="header">
        ...
        <div align="center">
             <h1>This Genre caanot be removed as it is used by many songs Click here to return <a href="../admin/genremgmt.jsp">Genre </a>>Management</h1>
        </div>
        <!-- Footer -->
